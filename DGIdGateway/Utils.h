...
public:
	...
	static void toHex(unsigned char* out, const unsigned char* in, unsigned int length);
	static void fromHex(unsigned char* out, const unsigned char* in, unsigned int length);
